...
from processors import (
    RobotStatusProcessor, RobotErrorProcessor,
    RobotPoseProcessor, RobotPowerProcessor
)
        ...
        for category_name, cases in self.test_data.items():
            ...
            for case in cases:
                ...
                if 'data' in response.to_dict():
                    ...
                    assert response.data['error_level'] == case['data']['error_level'] if 'error_level' in case['data'] else True
...
def run_processor_tests():
    ...
    # Test each processor
    test_classes = [
        TestRobotStatusProcessor,
        TestRobotErrorProcessor,
        TestRobotPoseProcessor,
        TestRobotPowerProcessor
    ]
