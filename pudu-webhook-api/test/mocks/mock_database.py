    ...
    def _define_table_schemas(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            'mnt_robots_management': {
                'fields': [
                    'robot_sn', 'status', 'battery_level', 'water_level',
                    'sewage_level', 'x', 'y', 'z', 'yaw', 'charge_state',
                    'last_updated'
                ],
                'primary_keys': ['robot_sn'],
                'field_types': {
            ...
            'mnt_robot_events': {
                'fields': [
                    'robot_sn', 'event_id', 'event_level', 'event_type',
                    'event_detail', 'task_time', 'upload_time'
                ],
                'primary_keys': ['robot_sn', 'event_id'],
                'field_types': {
                    'robot_sn': 'VARCHAR(50)',
