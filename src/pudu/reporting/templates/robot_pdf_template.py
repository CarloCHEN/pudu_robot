    ...
    def generate_comprehensive_pdf_content(self, content: Dict[str, Any], config: ReportConfig) -> str:
        ...
        try:
            ...
            <head>
                ...
                <title>{config.report_name or 'Robot Performance Report'} - {content.get('period', 'Latest Period')}</title>
    ...
    def _generate_executive_summary(self, content: Dict[str, Any], detail_level: str = 'in-depth') -> str:
        ...
        <section id="executive-summary" class="section">
            ...
            <div class="metrics-grid">
                ...
                <div class="metric-card">
                    <div class="metric-value">{cost_data.get('hours_saved', 0):.1f} hrs</div>
                    <div class="metric-label">Hours Saved vs Manual</div>
                    <div style="font-size: 9px; margin-top: 3px; color: {get_comparison_color(comparisons.get('hours_saved', 'N/A'))};">
                        vs last: {format_comparison(comparisons.get('hours_saved', 'N/A'))}
                    </div>
                </div>
                <div class="metric-card">
                    <div class="metric-value">${cost_data.get('savings', 0):,.0f}</div>
                    <div class="metric-label">Savings Realized</div>
                    <div style="font-size: 9px; margin-top: 3px; color: {get_comparison_color(comparisons.get('savings', 'N/A'))};">
            ...
            <<table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            {task_data.get('completion_rate', 0):.1f}%
                            <span style="color: {get_comparison_color(comparisons.get('completion_rate', 'N/A'))}; font-size: 9px; margin-left: 5px;">
